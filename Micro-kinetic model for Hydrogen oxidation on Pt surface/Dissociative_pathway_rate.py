...
#2. O2(g) + * -- O2*
#3. O2* + * -- 2O*
#4. O* + H* -- OH* + *          rate-determining step
#5. OH* + H* -- H2O* + *
#6. H2O* -- H2O(g) + *
#The following parameters are needed 
# dG1, dG2, dG3, dG4, dG5, dG6; dEa4; T; ph2, po2, ph2o
######################################################################
...
cov_site = 1/(1 + K1*ph2**0.5 + K2*po2 + (K2*K3*po2)**0.5 + ph2o/K6 + ph2o/(K1*K5*K6*ph2**0.5))
...
cov_OH = ph2o*cov_site/(K1*K5*K6*ph2**0.5)
cov_H2O = ph2o*cov_site/K6
...
Keq = K1**2*K2**0.5*K3**0.5*K4*K5*K6
y = ph2o/Keq/ph2/po2**0.5


# calculate the rate

rate = k4*K1*(K2*K3*po2)**0.5*ph2**0.5*cov_site**2*(1-y)
